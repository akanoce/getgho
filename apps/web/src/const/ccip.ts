...
const getCCIPRouterConfig = (network: string) => {
    switch (network) {
...
const GHO_TOKEN_ADDRESS_ARBITRUM_SEPOLIA = "0xb13Cfa6f8B2Eed2C37fB00fF0c1A59807C585810";

export { getCCIPRouterConfig, supportedNetworks, GHO_TOKEN_ADDRESS_ARBITRUM_SEPOLIA };
